...
const Phases = Object.freeze({
  INCEPTION: DB_COLLECTIONS.INCEPTIONS,
  ELICITATION: DB_COLLECTIONS.ELICITATIONS,
  ELABORATION: DB_COLLECTIONS.ELABORATIONS,
  NEGOTIATION: DB_COLLECTIONS.NEGOTIATIONS,
  SPECIFICATION: DB_COLLECTIONS.SPECIFICATIONS,
  VALIDATION: DB_COLLECTIONS.VALIDATIONS,
