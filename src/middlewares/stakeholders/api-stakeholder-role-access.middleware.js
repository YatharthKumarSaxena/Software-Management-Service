...
const stakeholderRoleAccessMiddlewares = {  
    ...
    updateInceptionStakeholderRoleAccessMiddleware: checkUserRoleFactory([ProjectRoleTypes.OWNER]),
    ...
    createMeetingStakeholderRoleAccessMiddleware: checkUserRoleFactory([ProjectRoleTypes.OWNER, ProjectRoleTypes.MANAGER]),
    cancelMeetingStakeholderRoleAccessMiddleware: checkUserRoleFactory([ProjectRoleTypes.OWNER, ProjectRoleTypes.MANAGER]),
    freezeMeetingStakeholderRoleAccessMiddleware: checkUserRoleFactory([ProjectRoleTypes.OWNER, ProjectRoleTypes.MANAGER]),
